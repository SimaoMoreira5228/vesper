...
private val singleOperationNames = mapOf(
    0x00 to "ADD.S",
    0x01 to "SUB.S",
    0x02 to "MUL.S",
    0x03 to "DIV.S",
...
private val compareNames = listOf(
...
fun disassembleCop1(pc: Int, insn: Int): String {
    ...
    return when (rs) {
        ...
        20 -> if (funct == 0x20) "CVT.S.W \$f$fd, \$f$fs"
        else "COP1.W/0x${funct.toString(16)} \$f$fd, \$f$fs"
